...
public class Lunar {
	 ...
	 * @throws Exception
	 */
	public static Date lunarToSolar(String lunarDate, boolean leapMonthFlag)
			throws Exception {
...
//		try {
//			SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
//			System.out.println(Lunar.lunarToSolar("20170111", false));
//			System.out.println(Lunar.solarToLunar(formatter.parse("20170728")));
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//	}
